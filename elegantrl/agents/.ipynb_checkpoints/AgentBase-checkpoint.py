...
#             ten_a = ten_a.reshape(-1)
    ...
    def convert_trajectory(self, buf_items, last_done):  # [ElegantRL.2022.01.01]
        ...
        for j in range(len(buf_items)):
            ...
            buf_items[j] = torch.cat(cur_item)
    ...
    def get_obj_h_term(self):
        ...
        ten_state = torch.cat(ten_state)  # ten_state.shape == (-1, state_dim)
        ten_action = torch.cat(ten_action)  # ten_action.shape == (-1, action_dim)
    ...
    def save_or_load_agent(self, cwd, if_save):
        ...
        def load_torch_file(model_or_optim, _path):
            ...
            model_or_optim.load_state_dict(state_dict) #無False
