...
class DRLAgent:
    ...
    def __init__(self, env, price_array, tech_array, turbulence_array,aug_state_array):
        self.env = env
...
#         self.current_working_dir = current_working_dir
    ...
    def get_model(self, model_name, model_kwargs,gpu_id =0):
        env_config = {
            "price_array": self.price_array,
            "tech_array": self.tech_array,
            "turbulence_array": self.turbulence_array,
            "aug_state_array" : self.aug_state_array,
            "if_train": True,
        }
